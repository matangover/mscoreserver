...
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.36/lib -lpng16 -lz -L/usr/local/Cellar/harfbuzz/2.3.0/lib -L/usr/local/Cellar/glib/2.60.0_1/lib -L/usr/local/opt/gettext/lib -L/usr/local/Cellar/pcre/8.43/lib -L/usr/local/Cellar/graphite2/1.3.13/lib -lharfbuzz -lm -framework ApplicationServices -lglib-2.0 -lintl -Wl,-framework,CoreFoundation -Wl,-framework,Carbon -Wl,-framework,Foundation -Wl,-framework,AppKit -liconv -lpcre -D_THREAD_SAFE -pthread -lgraphite2
build_libtool_libs := 
ft_version         := 18.1.12
